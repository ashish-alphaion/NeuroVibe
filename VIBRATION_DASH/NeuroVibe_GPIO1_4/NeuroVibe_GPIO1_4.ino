// NeuroSense BLE motor controller - GPIO1 through GPIO4 wiring variant
//
// Hardware:
//   ESP32-C3 Super Mini
//   DRV8833-compatible dual H-bridge module labelled IN1, IN2, IN3, IN4
//   Two 3 V ERM coin motors
//
// Connections:
//   GPIO1 -> DRV8833 IN1 (motor 1 control/PWM)
//   GPIO2 -> DRV8833 IN2 (motor 1 control)
//   GPIO3 -> DRV8833 IN3 (motor 2 control/PWM)
//   GPIO4 -> DRV8833 IN4 (motor 2 control)
//   GND   -> DRV8833 GND (common ground)
//   Motor 1 -> OUT1 and OUT2
//   Motor 2 -> OUT3 and OUT4
//
// Commands:
//   {"type":"get_status"}
...
constexpr char FIRMWARE_VERSION[] = "1.1.0-gpio1-4";
...
void applyFrequency(float hz) {
  ...
  // Forward PWM with fast decay: xIN1 receives PWM while xIN2 stays low.
...
void setup() {
  ...
  Serial.println("NeuroSense GPIO1-4 BLE controller ready");
}
